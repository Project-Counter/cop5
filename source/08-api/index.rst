...
COUNTER API for Automated Report Harvesting
===========================================
...
COUNTER previously used the terms SUSHI and COUNTER_SUSHI API to reference SUSHI-Lite, the RESTful version of SUSHI that was described in an unpublished NISO Technical Report.
