...
It is recommended to make custom reports available both from the administrative/reporting site and via the COUNTER_SUSHI API and to include them in the response for the /r51/reports path in the COUNTER_SUSHI API (see :numref:`api`).
