...
Syndicated usage
""""""""""""""""
Report providers wishing to include syndicated usage in their COUNTER reports, in compliance with the best practice on syndicated usage, MUST clearly mark the platforms on which usage occurred in the Platform field using the namespace SYNDICATED:{platform name}.