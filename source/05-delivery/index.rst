...
Report providers MUST make tabular versions of COUNTER reports available from an administrative/reporting site accessible by members of the institution requesting the report. All COUNTER reports provided by the report provider MUST also be available via the COUNTER_SUSHI API. Delivery requirements are:
