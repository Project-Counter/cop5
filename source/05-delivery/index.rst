...
* Tabular reports MUST be made available through a website.
  ...
  * The report interface MUST provide filter and configuration options for the COUNTER Reports that apply to the content provider.
  * The report interface MUST offer all Standard Views of the COUNTER Reports the content provider is required to provide, and Standard Views options MUST automatically apply the REQUIRED filter and configuration options and not allow the user to alter the filters or configuration options except for the usage begin and end dates.
