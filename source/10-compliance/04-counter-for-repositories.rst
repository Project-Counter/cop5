...
Repository infrastructure has developed substantially in the years since the release of the CRD. Release 5.1 of the main Code of Practice extended the type of outputs for which usage can be reported. Make Data Count and COUNTER therefore recommend that repositories and other data platforms should follow R5.1 instead of the CRD. This section lays out the similarities and differences between R5.1 and the CRD.


Attributes
""""""""""""

Key Attributes outlined in :numref:`counter-report-common-attributes-and-elements` are used the same way in R5.1 as they were in the CRD:
...
There are fields which are required in the IR but which do not appear in the CRD:
* Platform, which SHOULD be used to supply the repository name.
