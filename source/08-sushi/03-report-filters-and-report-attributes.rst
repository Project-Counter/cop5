...
Refer to :numref:`filters-attributes` and the `COUNTER_SUSHI API Specification <https://app.swaggerhub.com/apis/COUNTER>`_ for the list of filters and attributes supported by the various COUNTER reports.
